    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p className="footer-tagline">
              Connecting generations of DGI graduates. Building bridges between alumni, students, and teachers for lifelong success.
            </p>
          ...
          <div className="footer-links">
            <div className="footer-column">
              <h4>For You</h4>
              <ul>
                <li><a href="#who-this-is-for">Alumni</a></li>
                <li><a href="#who-this-is-for">Students</a></li>
                <li><a href="#who-this-is-for">Teachers</a></li>
        ...
        <div className="footer-bottom">
          <p>© 2026 DGI Alumni Network. All rights reserved.</p>
